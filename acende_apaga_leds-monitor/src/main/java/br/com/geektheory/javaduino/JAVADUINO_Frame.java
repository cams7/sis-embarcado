package br.com.geektheory.javaduino;
...
public class JAVADUINO_Frame extends javax.swing.JFrame {
	...
	private final String PUERTO = "COM2";
	...
	public JAVADUINO_Frame() {
		...
		jLabel1.setIcon(new ImageIcon(
				getURLBotaoIcon("IconoLedRojoApagado.png")));
		jLabel3.setIcon(new ImageIcon(
				getURLBotaoIcon("IconoLedAmarilloApagado.png")));
		setTitle("JAVADUINO");
	...
	public void inicializarConexion() {
		...
		while (puertoEnum.hasMoreElements()) {
			CommPortIdentifier actualPuertoID = (CommPortIdentifier) puertoEnum
					.nextElement();
	...
	private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
		...
		if (jRadioButton1.isSelected()) {
			...
			jLabel1.setIcon(new ImageIcon(getURLBotaoIcon("IconoLedRojo.png")));
		}
		if (jRadioButton2.isSelected()) {
			enviarDatos(TURN_Amarillo_ON);
			jLabel3.setIcon(new ImageIcon(
					getURLBotaoIcon("IconoLedAmarillo.png")));
		}
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(JAVADUINO_Frame.class.getName())
	...
	public static URL getURLImage(Class<?> classType, String img) {
		URL imageURL = classType.getClassLoader().getResource("imgs/" + img);
		return imageURL;
	}

	protected URL getURLBotaoIcon(String img) {
		URL imageURL = getURLImage(this.getClass(), img);
		return imageURL;
	}
